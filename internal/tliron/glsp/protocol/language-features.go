...
type InlayHintOptions struct {
	 ...
	 */
	ResolveProvider bool `json:"resolveSupport,omitempty"`
}
...
// Returns: []InlayHint | nil
type TextDocumentInlayHintFunc func(context *glsp.Context, params *InlayHintParams) (any, error)
...
type InlayHint struct {
	 ...
	 */
	Label any `json:"label,omitempty"` // string | InlayHintLabelPart[]
...
// Returns: []InlineValue | nil
type TextDocumentInlineValueFunc func(context *glsp.Context, params *InlineValueParams) (any, error)
 ...
 * @since 3.18.0
 */
type InlineCompletionTriggerKind Integer
